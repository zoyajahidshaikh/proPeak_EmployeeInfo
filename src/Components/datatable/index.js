...
export default class DataTable extends React.Component {
    ...
    renderTable = () => {
        ...
        return (
            <React.Fragment>
                <div className="row" >
                    <div className="col-sm-6 "> <h5> {title} </h5></div>
                    
                    {
                        this.props.show === false ? 
                            ...
                            <div className="col-sm-6 text-right">
                                {this.renderToolbar()} &nbsp; &nbsp;
                                <a title="Export to Pdf" onClick={() => this.createPdf()}><img style={{ height: '29px', marginRight: '-6px'}}
                                    src="/images/pdf.png" alt="Export to Pdf"></img></a>
                                &nbsp; &nbsp;

                           <CSVLink data={this.state.data} headers={this.state.excelHeaders} filename={this.state.filename}>
                                    <img style={{ height: '32px' }} title="Export to Excel"
                                        src="/images/xlsx.png" alt="Export to Excel"></img>
                                </CSVLink>
                            </div>
                    }
    ...
    renderToolbar = () => {
        return (
            <div className="toolbar float-right" id="toolbar">
                <button className="btn btn-sm btn-info" title="Search" onClick={this.onToggleSearch}>
